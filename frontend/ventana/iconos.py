...
Actualizado: 2026-07-20 (hora local)
"""
...
def _resolve_path(nombre: str) -> tuple[str | None, str]:
    """Resuelve la ruta del SVG según el conjunto activo.
...
def icono(nombre: str, size: int = 20, color: str | None = None) -> QIcon:
    """Retorna QIcon desde el conjunto activo.
    ...
    """
    path, real_set = _resolve_path(nombre)
